...
export async function GET(
  ...
  try {
    ...
    const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL || 'https://aino-backend-win-g4bdh6a7hxcgdhce.norwayeast-01.azurewebsites.net'}/api/content/unit/${unitId}`);
